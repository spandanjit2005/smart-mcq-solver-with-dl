...
arxiv_data = pl.read_csv("rag_pipeline/data/domains/arxiv_categories.csv")  
domain_data = pl.read_csv("rag_pipeline/data/domains/domain_counts.csv")

arxiv_keyword_data = arxiv_data.join(
    domain_data.select(["domain_name", "domain_keywords"]),
    on="domain_name",
    how="left"
)
...
category_search_schedule.write_csv("rag_pipeline/data/search_schedules/arxiv_search_schedule.csv")
